...
![23.png](img/23.png)
- Запустим ping c ws2, увидим, что ws1 перестала пинговаться
![24-1.png](img/24-1.png)
- Запустим ping c ws1 на ws2, увидим что пингуется
![24-11.png](img/24-11.png)
- обратную последовательность команд добавим для ws2 (в начале пишется разрешающее правило, а в конце пишется запрещающее правило)
![23.png](img/23-1.png)
